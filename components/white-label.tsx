  ...
  return (
    ...
    >
      <div className="mx-auto sm:p-8 p-6 gap-x-8 sm:gap-x-12  max-w-6xl">
        <h3 className="text-center font-[500] sm:font-[600] text-[#525266] text-[16px] sm:text-4xl sm:leading-[47px] leading-[20px] sm:mb-4 mb-2">
          From Order to Launch: <br /> Your Frienzy White-Label Timeline
        </h3>

        <p className="text-center  font-[300] text-[12px] sm:text-[18px]  sm:font-[400] text-[#525266ef] ">
